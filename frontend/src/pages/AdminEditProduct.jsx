...
function AdminEditProduct({ onClose,productdata,fetchdata }) {
    ...
    brandName: productdata?.productName,
  ...
  const handleSubmit = async(e) =>{
    ...
    const respose = await fetch(SummaryApi.updateProduct.url,{
    ...
    <div className='fixed w-full h-full top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
          <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
            ...
            <form className='grid p-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
              ...
              <button className='px-3 my-5 bg-red-600 text-white py-2 hover:bg-red-700 transition-all'>Update Product</button>
            </form>
